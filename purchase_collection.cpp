...
purchase_collection::purchase_collection(const purchase_collection &other)
{
    if(other.queue)
    {
...
int purchase_collection::size() const
{
    return this->count;
}

int purchase_collection::sum(const string &time_from, const string &date_from, const string &time_to, const string &date_to) const
{
...
int purchase_collection::input_from_file(const string &name)
{
    string time;
    string date;
    int amount;
...
int purchase_collection::output_to_file(const string &name)
{
    ofstream fout(name);
...
int purchase_collection::check_queue_date(const purchase &prev, const purchase &curr) const
{
